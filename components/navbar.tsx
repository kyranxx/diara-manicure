...
export function Navbar({ language = defaultLanguage, t = translations[defaultLanguage] }: NavbarProps) {
    ...
    return (
        <nav className="w-full bg-beige dark:bg-[#050403] z-50 relative">
            <div className="container mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 xl:gap-6">
                    ...
                    <details className="relative xl:hidden">
                        <summary
                        className="inline-flex size-10 items-center justify-center rounded-md text-primary transition-colors hover:bg-accent hover:text-accent-foreground"
                            aria-label={t.nav.openMenu}
                    >
                            <Menu className="size-6" />
                        </summary>
                        <div className="absolute right-0 top-full z-50 mt-3 w-72 rounded-xl border border-primary/10 bg-beige p-6 shadow-xl dark:bg-[#050403]">
